...
#     serialize_rules = ('-videos.user','-liked_videos.user', 'recruiter_interactions.user', '-sent_messages.user_message',)
...
#     sent_messages = db.relationship('Message', back_populates='user_message', lazy=True)

# class Recruiter(db.Model, SerializerMixin):
#     __tablename__ = "recruiters_table"

#     serialize_rules = ('-interactions.recruiter', '-received_messages.recruiter_message',)
...
#     received_messages = db.relationship('Message', back_populates='recruiter_message', lazy=True)
...
#     serialize_rules = ('-user_message.sent_messages', '-recruiter_message.sent_messages', '-interaction.messages',)
...
#     recruiter_message = db.relationship('Recruiter', back_populates='received_messages')
#     user_message = db.relationship('User', back_populates='sent_messages')
